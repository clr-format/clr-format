...
(function(Format) {
    ...
    (function(Utils) {
        ...
        /** @private */
        addValueAsKey = function(object, key, isArray) {
            ...
            object[resolveValueAsKey(value)] = isArray ? +key : key;
        };
        /** @private */
        ...
        merge = function(deep, target, object) {
            var key, copy, objectIsArray = Array.isArray(object);
...
(function(Format) {
    ...
    (function(Utils) {
        ...
        removeProperty = function(object, context) {
            ...
            if (isArray || Utils.isObject(object)) {
            ...
            return isArray ? Utils.Enumerable.compact(object) : object;
        };
...
(function(Format) {
    ...
    (function(Utils) {
        ...
        Utils.clone = createCloneFunction(function(object, deep, isArray) {
            return deep ? Utils.deepExtend(createExtendObject(object, isArray), object) : Utils.extend(createExtendObject(object, isArray), object);
        });
        /** @private */
        createExtendObject = function(object, isArray) {
            return isArray ? [] : {};
        };
...
(function(Format) {
    ...
    (function(Config) {
        ...
        (function(Definitions) {
            var addAll, asStatic, asPrototype, getProtoWrapper, unregister, globalRegistry = {}, globalPolyfills = [ Format.Utils.Numeric.isInteger ], prototypeRegistry = {}, prototypeExceptions = [ Format.Utils.Text.isNullOrWhitespace, Format.Utils.Function.getEmpty ];
