...
(function(Format) {
    ...
    (function(Globalization) {
        ...
        (function(DateTime) {
            ...
            DateTime.InvariantFormatter = InvariantFormatter;
        ...
        (function(DateTime) {
            ...
            var IntlOptionsProvider = function() {
                ...
                function IntlOptionsProvider(dateTimeOptions) {
                    this.resolvedOptions = Format.Utils.clone(dateTimeOptions);
                }
                /**
...
(function(Format) {
    ...
    (function(Globalization) {
        ...
        var DateTimeFormatInfo = function() {
            ...
            DateTimeFormatInfo.prototype.resolveFormatInfo = function(locales) {
                if (!locales) {
                    this.formatter = new Globalization.DateTime.InvariantFormatter(Globalization.DateTime.IntlOptionsProvider);
                } else {
        ...
        (function(Numeric) {
            ...
            var DecorationFormatter = function() {
                ...
                DecorationFormatter.prototype.getDecimalSeparator = function(formatInfo) {
                    ...
                    return this.isCurrency() ? formatInfo.CurrencyDecimalSeparator : formatInfo.NumberDecimalSeparator;
                };
                /**
                ...
                DecorationFormatter.prototype.getGroupSeparator = function(formatInfo) {
                    formatInfo = formatInfo || this.formatInfo;
                    return this.isCurrency() ? formatInfo.CurrencyGroupSeparator : formatInfo.NumberGroupSeparator;
                };
...
(function(Format) {
    ...
    function setCulture(locale) {
        Format.Globalization.CultureInfo.CurrentCulture = "" === locale ? Format.Globalization.CultureInfo.InvariantCulture : new Format.Globalization.CultureInfo(locale);
    }
    /**
...
module.exports.setCulture = Format.setCulture;

module.exports.setCurrency = Format.setCurrency;
