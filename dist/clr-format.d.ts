...
declare module Format.Utils {
     ...
     */
    function mapValuesAsKeys<T extends Indexable<number | string | symbol | RegExp> | string[]>(object: T): T;
}
...
declare module Format.Globalization {
    ...
    class NumberFormatInfo implements FormatProvider {
        ...
        private resolveCultureFormatInfo(locales);
    }
}
declare module Format.Globalization {
    /**
